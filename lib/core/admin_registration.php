...
//For registration
	...
	if(!$_POST['username'])
	{
		die("<p>Please enter a username.</p>");
	}
	
	if(strlen($_POST['username'])<4 || strlen($_POST['username'])>15)
	{
		die("<p>Username must be between 4 and 15 characters.</p>");
	}
	...
	{
		die("<p>Passwords must be atleast 5 characters.</p>");
	}
	...
	elseif(!$_POST['email'])
	{
		die("<p>Please enter an email address.</p>");
	}
