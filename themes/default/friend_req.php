...
$query1 = mysql_query('SELECT * FROM friend_requests WHERE to_id = "'.$me.'" AND status="1"');
?>
                 ...
                 <!--========HEADER=====---->
                  ...
                  <div class="row">
                   <div class="panel panel-default tabless-panel timeline-layout overflow">
                     <div class="panel-heading">
                      <div class="text-muted isvipi-title">Friend Requests
                      </div><!--/text-muted-->
                    </div><!--/panel-heading-->
                  <div class="isvipi-panel-content isvipi-panel-content-width2">
                       ...
                       <table class="table">
                                    ...
                                    <tbody>
<?php
//We display the list of friend requests
...
?>  
                                ...
                                <a href="accept_request.php?id=<?php echo $not['request_id']; ?>" title="Accept Friend Request"><i class="fa fa-check"></i></a>
                                <a href="reject_request.php?id=<?php echo $not['request_id']; ?>" title="Reject Friend Request"><i class="fa fa-times"></i></a>
                                </div></td>
                                        </tr>
<?php
}
