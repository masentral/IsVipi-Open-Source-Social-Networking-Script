    ...
    <!-- left, vertical navbar -->
       <div class="col-md-4">
           <ul class="nav navbar-collapse collapse sidebar-menu">
               <li <?php global $ACTION; if ($ACTION[0]=="home"){echo "class='active'";}?>><a href="<?php echo ISVIPI_URL.'home/' ?>" title="My Dashboard"><i class="fa fa-home"></i> Dashboard</a></li>
               <?php global $username?>
               <?php if (isAdmin()==FALSE){?><li <?php if ($ACTION[0]=="profile"){echo "class='active'";}?>><a href="<?php echo ISVIPI_URL.'profile/' ?><?php echo htmlspecialchars($username, ENT_QUOTES, 'utf-8');?>" title="My Public Profile"><i class="fa fa-eye-slash"></i> My Profile</a></li>
